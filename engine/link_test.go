...
// goto (ADR-0132). It uses the raw builder API: b.AddLinkThrowEvent / b.AddLinkCatchEvent are
...
// Operations overlay lights them up) and completing the instance (ADR-0132).
...
// the CompiledProcess, re-derived on Deploy) — ADR-0132, invariant I6.
