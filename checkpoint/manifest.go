...
// checkpoints (ADR-0132). A checkpoint is a consistent Pebble snapshot of the state
...
// restoring from them, and compacting WAL segments are later slices of ADR-0132; none
...
// checkpoint or genesis replay (ADR-0132): pre-1.0 there is no in-place migration.
...
// Manifest is the engine-owned descriptor of a recovery checkpoint (ADR-0132). It is
...
// the checkpoint and fall back rather than fail (ADR-0132).
