...
var mcpToolRoutes = map[string]string{
	...
	"atlas_list_value_streams":           "GET /api/v1/value-streams",
	"atlas_get_value_stream":             "GET /api/v1/value-streams/{key}",
	...
	"atlas_infomodel_subset":             "GET /api/v1/infomodel/subset",
