...
//
// # Why this is not the text-file worker
//
// ADR-0139's worker covers the *table* formats: delimited, fixed-width, and
...
// the downstream handling a live directory read does, and a worker whose result
