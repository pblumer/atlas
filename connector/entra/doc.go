...
// through the Microsoft Graph API on behalf of a BPMN service task (ADR-0171).
//
// # What it is for
//
...
// # Worker-only
//
// Like the SQL connectors (ADR-0170) and unlike everything built before them, this
