...
// OAuth2 grant methods a SharePoint connector supports (ADR-0105). clientCredentials
...
// connector's credentialsRef (ADR-0105). method selects the OAuth2 grant; the
