...
// (ADR-0140), mirroring how the mail package delegates a send to a registry-managed
...
// token (ADR-0140), reusing the same grant shapes as the native mail providers
// (ADR-0093).
//
