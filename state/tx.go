...
// (ADR-0078). Like the active-children counter they are write-only composing merges,
...
// current count is needed — the singleton-start gate (ADR-0078), not on every merge.
