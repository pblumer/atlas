...
// AddLinkThrowEvent adds a link intermediate throw event — a goto (ADR-0126). It carries no
...
// of the same name (ADR-0126). Like the throw it carries no detail and runs as a pass-through,
