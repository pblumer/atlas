...
// the throw to the catch — the goto (ADR-0132). The throw has no real outgoing flow in the XML;
...
// to the one catch — many gotos, one label (ADR-0132).
...
// that scope — the throw wires to the catch drawn in the same subprocess (ADR-0132).
...
// collide — the name spaces are separate (ADR-0132).
