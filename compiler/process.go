...
type ConnectorTaskDetail struct {
	...
	// by its own field-relative selector and attribute (ADR-draft-webscrape-structured-extraction).
...
// (ADR-draft-webscrape-structured-extraction): Name is the key the extracted value
