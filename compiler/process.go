...
//     created item's JSON is written into ResultVar when set (ADR-0140).
...
type ConnectorTaskDetail struct {
	...
	Body        RestExpr
	// CSV connector fields (JobType == CsvImportJobType, ADR-0138). CsvSource is the
	...
	CsvHasHeader bool
	CsvColumns   []int32
	// SharePoint connector fields (JobType == SharePointJobType, ADR-0140). Connector
