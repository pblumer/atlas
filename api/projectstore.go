...
// together in the Modeler (ADR-0024). It holds only organizational metadata:
...
// existing project with the same id — the path a rename takes (I2 / ADR-0024).
...
// name an existing project and read as Ungrouped (ADR-0024).
