...
func (s *Server) apiRoutes() []apiRoute {
	return []apiRoute{
		...
		{"GET", "/api/v1/catalog-products/fulfilment-report", s.catalogs.HandleFulfilmentReport, apiOp{
