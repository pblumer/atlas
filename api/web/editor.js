...
// re-evaluated on every variable change (ADR-0134).
...
// the event fires when it becomes true (ADR-0134). ced is the bpmn:ConditionalEventDefinition.
...
function wireProperties(root, modeler, api, projectId, toast) {
  ...
  function show(element) {
    ...
    // <condition> FormalExpression body (ADR-0134). Clearing it removes the condition (the
