...
(function workerConsoleTerminology() {
  ...
  function patchWorkerPage() {
    ...
    if (catalogCard) {
      ...
      replaceHTML(catalogCard.querySelector("p.muted"),
    ...
    for (const h2 of view.querySelectorAll("h2")) replaceText(h2, "Configured connectors", "Configured workers");
    ...
    if (configuredCard) {
      replaceHTML(configuredCard.querySelector("p.muted"),
      ...
      replaceText(configuredCard.querySelector("thead th"), "Connector", "Worker");
    }
