...
var builtInManagedWorkerTypes = []builtInWorkerTypeMetadata{
	...
	{ConnectorKind: connectorKindDiscord, ID: "atlas.discord", Version: initialBuiltInWorkerTypeVersion, Title: "Discord", Vendor: "Atlas", Origin: WorkerTypeOriginBuiltIn, RuntimeMode: WorkerRuntimeModeAtlasEmbedded},
	{ConnectorKind: connectorKindS3, ID: "atlas.s3", Version: initialBuiltInWorkerTypeVersion, Title: "S3 object storage", Vendor: "Atlas", Origin: WorkerTypeOriginBuiltIn, RuntimeMode: WorkerRuntimeModeAtlasEmbedded},
	...
	{ConnectorKind: connectorKindAgent, ID: "atlas.agent", Version: initialBuiltInWorkerTypeVersion, Title: "AI agent model", Vendor: "Atlas", Origin: WorkerTypeOriginBuiltIn, RuntimeMode: WorkerRuntimeModeAtlasSupervised},
