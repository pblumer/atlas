...
```bash
curl -fsSLO https://github.com/pblumer/atlas/releases/latest/download/atlas_0.1.0_linux_amd64.tar.gz
tar -xzf atlas_0.1.0_linux_amd64.tar.gz
./atlas_0.1.0_linux_amd64/atlas serve
```
...
`sha256sum` must print `atlas_0.1.0_linux_amd64.tar.gz: OK`. If it prints
...
```powershell
C:\Atlas\atlas_0.1.0_windows_amd64\atlas.exe serve --addr 127.0.0.1:8080 --data-dir C:\Atlas\data
```
...
<service>
  ...
  <executable>C:\Atlas\atlas_0.1.0_windows_amd64\atlas.exe</executable>
