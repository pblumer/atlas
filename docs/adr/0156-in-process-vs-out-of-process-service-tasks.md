...
- extended by [ADR-0157](0157-worker-processes-supervision-and-console.md), which re-decides this record's rejected option 5 once Atlas launches the worker itself, and sequences the follow-ups below
