...
| [0401](0401-graph-identity-across-several-logs.md) | What a node is called when there is more than one log | Accepted | Not started |
...
| [0404](0404-the-whole-graph-can-be-walked.md) | The whole graph can be walked, in a projection with a stated scope | Accepted | Not started |
