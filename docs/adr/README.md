...
| [0138](0138-csv-to-json-connector.md) | A first-class "CSV to JSON" connector kind with model-authored layout (renumbered from a duplicate 0090) | Accepted |
| [0139](0139-live-collaborative-modeling-sessions.md) | Live collaborative modeling sessions — real-time co-editing of drafts by people and AI agents (renumbered from a duplicate 0103) | Proposed |
| [0140](0140-sharepoint-connector.md) | SharePoint connector — create a list item via Microsoft Graph, provider managed and OAuth credential in the vault (renumbered from a duplicate 0105) | Accepted |
