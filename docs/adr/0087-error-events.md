# ADR-0087: Error events (scoped propagation to the nearest handler)
...
- sibling to ADR-0086 (signal events) — the other outstanding Milestone-2 event type, with the
