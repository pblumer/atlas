...
- **[Pega comparison](docs/comparisons/pega.md)** — the Pega Platform's case-management and decisioning scope against Atlas's BPMN execution scope, capabilities only
