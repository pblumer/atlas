...
- <img src="docs/brand/icons/agents.svg" width="18" height="18" align="absmiddle" alt=""> **Made for AI agents.** `atlas mcp` exposes 128 Model Context Protocol tools, so an agent can author, deploy, run and inspect processes over the same API you do.
