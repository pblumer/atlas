...
- **Retries is a property of every job-backed task**
  ([ADR-0134](docs/adr/0134-retries-as-a-task-property.md)): the retry budget the incident
...
- **A retry budget below 1 is refused at deploy**
  ([ADR-0134](docs/adr/0134-retries-as-a-task-property.md)): `retries="0"` (or a negative
